...
function SignupFormContent() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      email: "",
      password: "",
      role: (role === "RIDER" || role === "FIXER") ? role : "RIDER",
      postalCode: "",
      phoneNumber: "",
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="RIDER">Mijn fiets laten repareren</SelectItem>
                    <SelectItem value="FIXER">Geld verdienen als fixer</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    Je krijgt €4 korting op je eerste boeking!
                  </p>
                </FormItem>
              )}
            />
...
// Main SignupPage component with Suspense
