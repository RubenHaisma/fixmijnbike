    ...
    <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
      ...
      {(error || callbackError) && (
        <Alert variant="destructive">
          ...
          <AlertDescription>{error || "Er is een fout opgetreden bij het inloggen."}</AlertDescription>
        </Alert>
      )}
      ...
      {callbackSuccess && (
        <Alert className="bg-green-50 border-green-200">
          ...
          <AlertDescription className="text-green-800">
            {callbackSuccess === "verification" 
              ? "E-mail geverifieerd. Je kunt nu inloggen." 
              : "Actie succesvol. Je kunt nu inloggen."}
          </AlertDescription>
        </Alert>
      )}
...
// Main LoginPage component with Suspense
