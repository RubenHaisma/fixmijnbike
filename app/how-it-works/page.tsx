          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-700 md:text-xl">
                FixMijnBike verbindt studenten met fietsreparatie behoeften aan student &quot;fixers&quot; die extra geld willen verdienen.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center mb-12">
            <div className="p-3 rounded-full bg-orange-100">
              <Bicycle className="h-8 w-8 text-primary" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-orange-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm">1</span>
                <Bicycle className="h-8 w-8 text-primary" />
              </div>
            ...
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-orange-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm">2</span>
            ...
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-orange-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm">3</span>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 rounded-full bg-orange-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm">4</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-blue-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center font-bold text-sm">1</span>
                <Wrench className="h-8 w-8 text-secondary" />
              </div>
            ...
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-blue-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center font-bold text-sm">2</span>
            ...
            <div className="flex flex-col items-center space-y-4 relative">
              <div className="p-4 rounded-full bg-blue-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center font-bold text-sm">3</span>
                <Bicycle className="h-8 w-8 text-secondary" />
              </div>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 rounded-full bg-blue-100 relative">
                <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center font-bold text-sm">4</span>
                <Euro className="h-8 w-8 text-secondary" />
              </div>
      ...
      <section className="w-full py-12 md:py-24 bg-white">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="border rounded-xl p-6 bg-orange-50 border-orange-100 shadow-sm">
              <div className="flex items-center mb-4">
                <Bicycle className="h-8 w-8 text-primary mr-3" />
                <h3 className="text-2xl font-bold text-primary">Voor Riders</h3>
              </div>
            ...
            <div className="border rounded-xl p-6 bg-blue-50 border-blue-100 shadow-sm">
              <div className="flex items-center mb-4">
                <Wrench className="h-8 w-8 text-secondary mr-3" />
                <h3 className="text-2xl font-bold text-secondary">Voor Fixers</h3>
              </div>
